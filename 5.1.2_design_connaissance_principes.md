...
D'après les travaux de Hargrave et Van de Ven (2017), qui se basent sur une large revue des différentes approches managériales permettant d'aborder les tensions paradoxales, nous pouvons isoler 5 mécanismes permettant de favoriser l'usage. Je considère ces 5 mécanismes, et la configuration PIMCO (Carlsson, 2006) dans lesquelles ils s'inscrivent, comme 5 principes de design donnant l'orientation génerale du design de mon artefact. 
