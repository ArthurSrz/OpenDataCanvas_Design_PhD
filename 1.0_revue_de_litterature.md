...
Nous utiliserons ici le framework multi-niveau développé par Chesbrough and Bogers (2014) et affiné par Bogers et al. (2016) pour classer la littérature sur le concept d'open innovation (Chesbrough, 2003) selon le niveau d'analyse. Il distingue 5 niveaux/unités d'analyse permettant de classer les déterminants, process et résultats d'un phénomène : 
