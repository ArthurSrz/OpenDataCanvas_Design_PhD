...
Dans cette partie, il est question de choisir une stratégie d'évaluation en reportant dans les 7 critères de la version 0 du prototype de l'Open Data Canvas décrits dans [la partie précédente](7.1.1_connaissance_evaluation.md)
