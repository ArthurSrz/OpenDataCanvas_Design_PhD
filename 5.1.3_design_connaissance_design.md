...
## Construction d'un scenario d'usage compilant les pattern de coordination de l'artefact avec un contexte réel de développement des usages des données ouvertes
