...
La mise en oeuvre de normes techniques et sociales est un moyen d'orienter le comportement et les tâches effectuées par les acteurs sur le réseau (qu'ils soient producteurs, intermédiaires ou réutilisateurs). Cette orientation ou surdétermination va leur faire acquérir progressivement un savoir-faire sur le management des coomposants du réseau qu'ils pourront transposer dans l'usage des données ouvertes _per se_.   Elles vont venir fixer des règles comportementales et techniques comparables 
