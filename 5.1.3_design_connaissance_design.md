...
| Etapes de l'usage des données                                               | Fonction                                                       | Description de la fonction                                                                                |
|-----------------------------------------------------------------------------|----------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------|
| Création d'un cadre cognitif partagé entre les systèmes pour les coordonner | 17\) Ajout de nouvelles pratiques dans le codebook             | Les utilisateurs peuvent proposer l'ajout de nouvelles pratiques au sein du codebook                      |
| Institutionnalisation de l'usage des données ouvertes                       | 18\) Développement de service et produits à partir du codebook | Les utilisateurs peuvent intégrer le manifeste et le codebook dans des applications/services compatibles  |
