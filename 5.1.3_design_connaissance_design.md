...
------------ | 
 ...
 |              | Scenario 1 \- Rallier                                                                                                           | Scenario 2 \- Mutualiser                                                                        | Scenario 3 \- Mettre à disposition une forge                                                                                                           |
|--------------|---------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| Partenaires  | Acteurs locaux coordonnés à l’échelle nationale                                                                                 | Chef de projet utilisant des données ouvertes                                                   | "                                                                                                                                                      |
| Tâches       | co\-construction du manifeste et du codebook                                                                                    | Déposer des connaissances dans le système de gestion des tâches                                 | Décrire les usages qu’ils souhaitent développer                                                                                                        |
| "            | developper des produits ou services à partir du manifeste et du codebook                                                        | Acquisition d’un savoir\-faire homogène                                                         | Être questionné pour formuler le paradoxe qu’ils contiennent                                                                                           |
| "            | "                                                                                                                               | Obtenir des retours sur les tâches planifiées de la part de l’écosystème                        | Etablir un plan de développement des usages                                                                                                            |
| "            | "                                                                                                                               | Organiser/Visualiser les tâches à réaliser                                                      | Solliciter des feedback sur ce plan de la part des acteurs de l’écosystème                                                                             |
| "            | "                                                                                                                               | Utiliser les connaissances relatives aux tâches permettant de développer les usages             | "Inventorier les données à utiliser, les documenter et interagir avec l’écosystème autour d’elles"                                                     |
| "            | "                                                                                                                               | Placer les ressources dans le modèle de métadonnées                                             | Utiliser le réseau d’information pour s’orienter dans la réalisation des tâches nécessaires à l’usage                                                  |
...
| Outputs      | Diffusion du manifeste et du codebook                                                                                           | Mutualiser et diffuser un savoir\-faire homogène                                                | Permettre à un maximum d’acteurs de se lancer dans  l’usage des données ouvertes                                                                       |
| "            | Renforcer l’adhésion des communautés vàv du manifeste et du codebook                                                            | "                                                                                               | "                                                                                                                                                      |
