...
En ce qui concerne le classement des ressources, les acteurs évoquent régulièrement l'importance de créer une classification modelable, rôle qu'occupe notre modèle de méta-données
...
------------ | 
 ...
 |                                                                                                        | Scenario 1 - Rallier                                                                                                             | Scenario 2 - Mutualiser                                                                         | Scenario 3                                                                                                                                             | 
|--------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------| 
| Items - environnement d’utilisation de l’artefact                                                      |                                                                                                                                  |                                                                                                 |                                                                                                                                                        | 
| Utilisateurs                                                                                           | Acteurs institutionnels ou associatif oeuvrant au niveau territorial et/ou national pour favoriser l'usage des données ouvertes. | Tout acteur indivivuel impliqué dans un projet de développement des usages des données ouvertes | "Groupes de réutilisateurs de données répartis par territoire, par organisation ou par thématique"                                                     | 
| Partenaires                                                                                            | Acteurs locaux coordonnés à l’échelle nationale                                                                                  | Chef(fes) de projet utilisant des données ouvertes                                              |                                                                                                                                                        | 
| Tâches                                                                                                 | "Co-construction du manifeste et du codebook                                                                                     |                                                                                                 |                                                                                                                                                        | 
|                                                                                                        |                                                                                                                                  |                                                                                                 |                                                                                                                                                        | 
| Développer des produits ou services à partir du manifeste et du codebook"                              | "Déposer des connaissances dans le système de gestion des tâches                                                                 |                                                                                                 |                                                                                                                                                        | 
|                                                                                                        |                                                                                                                                  |                                                                                                 |                                                                                                                                                        | 
| Placer les ressources dans le modèle de métadonnées                                                    |                                                                                                                                  |                                                                                                 |                                                                                                                                                        | 
|                                                                                                        |                                                                                                                                  |                                                                                                 |                                                                                                                                                        | 
| Utiliser les connaissances relatives aux tâches permettant de développer les usages                    |                                                                                                                                  |                                                                                                 |                                                                                                                                                        | 
|                                                                                                        |                                                                                                                                  |                                                                                                 |                                                                                                                                                        | 
| Organiser/Visualiser les tâches à réaliser                                                             |                                                                                                                                  |                                                                                                 |                                                                                                                                                        | 
|                                                                                                        |                                                                                                                                  |                                                                                                 |                                                                                                                                                        | 
| Obtenir des retours sur les tâches planifiées de la part de l’écosystème                               |                                                                                                                                  |                                                                                                 |                                                                                                                                                        | 
|                                                                                                        |                                                                                                                                  |                                                                                                 |                                                                                                                                                        | 
| Acquisition d’un savoir-faire homogène"                                                                | "Décrire les usages qu’ils souhaitent développer                                                                                 |                                                                                                 |                                                                                                                                                        | 
|                                                                                                        |                                                                                                                                  |                                                                                                 |                                                                                                                                                        | 
| Être questionné pour formuler le paradoxe qu’ils contiennent                                           |                                                                                                                                  |                                                                                                 |                                                                                                                                                        | 
|                                                                                                        |                                                                                                                                  |                                                                                                 |                                                                                                                                                        | 
| Etablir un plan de développement des usages                                                            |                                                                                                                                  |                                                                                                 |                                                                                                                                                        | 
|                                                                                                        |                                                                                                                                  |                                                                                                 |                                                                                                                                                        | 
| Solliciter des feedback sur ce plan de la part des acteurs de l’écosystème                             |                                                                                                                                  |                                                                                                 |                                                                                                                                                        | 
|                                                                                                        |                                                                                                                                  |                                                                                                 |                                                                                                                                                        | 
| Inventorier les données à utiliser                                                                     |  les documenter et interagir avec l’écosystème autour d’elles                                                                    |                                                                                                 |                                                                                                                                                        | 
|                                                                                                        |                                                                                                                                  |                                                                                                 |                                                                                                                                                        | 
| Utiliser le réseau d’information pour s’orienter dans la réalisation des tâches nécessaires à l’usage" |                                                                                                                                  |                                                                                                 |                                                                                                                                                        | 
| Ressources                                                                                             | Communautés en ligne et/ou réseau de collectivités                                                                               | Accès privilégié pour récupérer les tâches et ressources à la source.                           | Connaissances couvrant l’ensemble des étapes propres à l’usage des données et pouvant être utilisées avec un minimum d’accompagnement                  | 
| Information ou flux d’information                                                                      |                                                                                                                                  |                                                                                                 |                                                                                                                                                        | 
| Outputs                                                                                                | "Diffusion du manifeste et du codebook                                                                                           |                                                                                                 |                                                                                                                                                        | 
|                                                                                                        |                                                                                                                                  |                                                                                                 |                                                                                                                                                        | 
| Renforcer l’adhésion des communautés vàv du manifeste et du codebook"                                  | - Mutualiser et diffuser un savoir-faire homogène                                                                                | Permettre à un maximum d’acteurs de se lancer dans  l’usage des données ouvertes                |                                                                                                                                                        | 
| Items - environnement structurel des utilisateurs de l’artefact                                        |                                                                                                                                  |                                                                                                 |                                                                                                                                                        | 
| Schèmes                                                                                                | Dispersion des communautés                                                                                                       | Pont/Liaison entre les systèmes d’un écosystème                                                 | Lancer la dynamique d’usage des données ouvertes                                                                                                       | 
| Normes                                                                                                 | Agir a minima à l’échelle nationale                                                                                              | Désigner la mutualisation des ressources comme partie intégrante de projets concrets            | Permettre à des néophytes de l’open data de mener une démarche de bout en bout en béneficiant d’un accompagnement frugal sur l’ensemble de la démarche | 
| Facilités                                                                                              | Moyens et autorités d’un réseau d’acteur national                                                                                | Notoriété d’un “tiers de confiance” pour mutualiser les connaissances                           | Sceau ou tampon officie d’une entité reconnue  affiché sur la “forge”                                                                                  | 
