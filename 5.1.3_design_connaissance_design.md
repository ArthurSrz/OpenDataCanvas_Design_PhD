...
|                                                                                      | 14\) Transfert automatique des réponses                                                 | Les réponses de l'utilisateur sont transférées dans une base de données relationnelles                                                                                                             |
|                                                                                      | 15\) Création de questionnaires                                                         | Les utilisateurs peuvent créer des questionnaires qui vont venir peupler la base de données relationnelles dans le but d'obtenir des feedback de la part des acteurs des autres systèmes           |
|                                                                                      | 16\) Création de vues de la base de données relationnelles                              | Les utilisateurs vont pouvoir prendre acte des feedback en créant de nouvelles vues de la base de données pour montrer les évolutions du plan d'action suite aux retours                           |
