...
- [ ] Premier mécanisme : création collaborative et communautaire de la docmentation sur système connu des pionniers de l'open data - readthedocs X Github --> intégration progressive. 
- [ ] Deuxième mécanisme : créer une hotline pour les utilisateurs de données ouvertes visant à les orienter vers la partie du codebook qui les aidera dans la réalisation de leurs tâches (cf évènement ODS - Data on board)
