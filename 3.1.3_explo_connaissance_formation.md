...
| Institutionnalisation de l'usage des données                                         | L'incompatibilité des cultures organisationnelles avec l'open data                                  |
|                                                                                      | Divergence des positions des acteurs sur l'équilibre entre risques et opportunités de l'open data   |



**Un modèle théorique affiné pour comprendre l'usage des données ouvertes**

Le framework présenté ci-dessous nous permet d'affiner le modèle théorique présenté dans la première section de ce chapitre. Plus particulièrement, il vient modifier notre compréhension de 3 éléments : 
