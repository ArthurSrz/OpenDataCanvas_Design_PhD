...
|                                           | Arrêt des séquences d'articulation (Articulation technique --> Articulation sociale)                              |                         | Le faible niveau d'information sur les métadonnées rend l'interprétation du sens des données difficile                                                                     | Conradie et Choenni \(2012\)                                   |
...
|                                           |                                                                 |                         |                                                                                                                                                                            |                                                                |
| Social \(interactions sociales\)          | Mise en place d'une organisation sociale autour des plateformes |                         |                                                                                                                                                                            |                                                                |
|                                           |                                                                 |                         |                                                                                                                                                                            |                                                                |
|                                           |                                                                 |                         |                                                                                                                                                                            |                                                                |
...
|                                           |                                                                 |                         |                                                                                                                                                                            |                                                                |
|                                           |                                                                 |                         |                                                                                                                                                                            |                                                                |
|                                           | Inhibition des capacités d'action des artefacts sociaux         |                         |                                                                                                                                                                            |                                                                |
|                                           |                                                                 |                         |                                                                                                                                                                            |                                                                |
|                                           |                                                                 |                         |                                                                                                                                                                            |                                                                |
|                                           | Arrêt des séquences d'articulation (Articulation sociale --> Articulation technique)                              |                         | Les utilisateurs manque de connaissances sur un domaine ce qui rend difficile de connecter, comparer et croiser des données                                                | King et al\. \(2011\)                                          |
|                                           |                                                                 |                         |                                                                                                                                                                            |                                                                |
|                                           |                                                                 |                         |                                                                                                                                                                            |                                                                |
