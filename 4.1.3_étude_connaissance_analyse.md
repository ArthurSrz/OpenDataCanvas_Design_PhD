...
Nous définissons comme fonctionnalités de la plateforme open data toutes les modalités permettant à un utilisateur de la plateforme (qu'il soit producteur, intermédiaire ou réutilisateur) d'y injecter des données ou d'accèder aux données qu'elle contient déjà. Pour les producteurs de données qui souhaiteraient ouvrir leurs données sur la plateforme, les plateformes des deux cas offrent des espaces qu'ils peuvent utiliser de manière autonome. 
